...
import { BasicKVP, BasicProperty, PropertyItem, SPDomainData, DisplayOption, LoggedInUser, MenuInfo, LoadingSpinnerInfo, StatusIndicatorItem, PollingInfoContext } from "../../DataModels/HelperModels";
...
interface C2CLayoutViewProps {
    
}

const C2CLayoutView: React.FC<C2CLayoutViewProps> = ({ }) => {
